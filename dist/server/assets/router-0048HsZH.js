...
const appCss = "/assets/styles-CNrTjeyI.css";
...
const logoLight = "/assets/logo-light-C1-OvZjU.png";
const logoDark = "/assets/logo-dark-BfYF9qh4.png";
...
function useTheme() {
  const [theme, setThemeState] = reactExports.useState(currentTheme);
  reactExports.useEffect(() => {
    try {
  ...
  const setTheme = reactExports.useCallback((t) => setGlobalTheme(t), []);
...
function ThemeToggle({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      className: `relative inline-flex h-9 w-9 items-center justify-center rounded-full border border-border text-foreground/80 transition hover:text-primary hover:border-primary ${className}`,
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed inset-x-0 top-0 z-50 transition-all duration-500 ${scrolled ? "bg-onyx/85 backdrop-blur-xl border-b border-border" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-[1400px] items-center justify-between px-6 py-4 lg:px-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Prestige Motors", className: "h-11 w-auto" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "px-5 py-2.5 text-xs uppercase tracking-[0.25em] bg-gradient-gold text-primary-foreground font-medium hover:shadow-gold transition-all", children: "Visit Showroom" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex lg:hidden items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeToggle, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setOpen(!open), className: "text-foreground", "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 26 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 26 }) })
          ] })
        ] }),
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-onyx/95 backdrop-blur-xl border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col px-6 py-6 gap-1", children: nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: n.to,
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-border bg-onyx", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-[1400px] px-6 lg:px-10 py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl tracking-widest text-foreground", children: "PRESTIGE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.4em] text-muted-foreground mb-6", children: "MOTORS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Curators of the world's most exceptional automobiles. Crafting confidence on every road." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-3", children: [Instagram, Facebook, Twitter, Youtube].map((Icon2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "flex h-10 w-10 items-center justify-center rounded-full border border-border text-foreground/70 transition hover:border-primary hover:text-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16 }) }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-[0.3em] text-primary mb-6", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-foreground/75", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cars", className: "hover:text-primary transition", children: "All Vehicles" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "hover:text-primary transition", children: "Services" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blogs", className: "hover:text-primary transition", children: "Editorial" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-primary transition", children: "Contact Us" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-[0.3em] text-primary mb-6", children: "Categories" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-foreground/75", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Featured Motors" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Armoured Vehicles" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Limited Editions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Pre-owned" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-[0.3em] text-primary mb-6", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 text-sm text-foreground/75", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, className: "mt-0.5 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Sheikh Zayed Road, Dubai, UAE" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, className: "mt-0.5 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+971 4 000 0000" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 16, className: "mt-0.5 text-primary shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "info@prestigemotors.ae" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-line my-12 opacity-30" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground tracking-wider", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " PRESTIGE MOTORS. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tracking-[0.3em] uppercase", children: "Crafted with precision" })
    ] })
  ] }) });
}
...
const Route$8 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Prestige Motors — Curators of Exceptional Automobiles" },
      { name: "description", content: "Discover the world's most coveted luxury, performance, and armoured automobiles at Prestige Motors." },
      { property: "og:title", content: "Prestige Motors" },
      { property: "og:description", content: "Curators of exceptional automobiles." },
...
const $$splitComponentImporter$7 = () => import("./services-DDfD_T7t.js");
const Route$7 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bespoke services for the most discerning collectors — from sourcing to armouring."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./contact-Fq2yvR0R.js");
const Route$6 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Visit our flagship showroom or schedule a private consultation."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./about-BgbPdk9i.js");
const Route$5 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The story, philosophy, and people behind Prestige Motors — curators of the world's most exceptional automobiles."
    }, {
      property: "og:title",
      content: "About Us — Prestige Motors"
    }, {
      property: "og:description",
      content: "Curators of the world's most exceptional automobiles. Discover our story."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-C8yCu34U.js");
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./cars.index-CGBr6xr6.js");
const Route$3 = createFileRoute("/cars/")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./blogs.index-hQtlhzay.js");
const Route$2 = createFileRoute("/blogs/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Stories and insights from the world of exceptional automobiles."
    }, {
      property: "og:title",
      content: "Editorial — Prestige Motors"
    }, {
      property: "og:description",
      content: "Stories and insights from the world of exceptional automobiles."
    }]
...
const car1 = "/assets/car-1-BCdXTJsL.jpg";
const car2 = "/assets/car-2-BZ72z162.jpg";
const car3 = "/assets/car-3-DFzIR6sg.jpg";
const car4 = "/assets/car-4-C4Hp20Hl.jpg";
const a1 = "/assets/armoured-1-Bk49V3KN.jpg";
const a2 = "/assets/armoured-2-CIAFVxR4.jpg";
const a3 = "/assets/armoured-3-BlgWg-UH.jpg";
const a4 = "/assets/armoured-4-DJaf7j4Y.jpg";
const cars = [
  {
    ...
    description: "The darker, more assertive side of Rolls-Royce. The Cullinan Black Badge merges presence with performance — sculpted from carbon-fibre composites, finished in obsidian black, and tuned for the discerning driver who refuses convention.",
    brand: "Rolls-Royce",
    status: "New",
    category: "Normal",
    priceAED: 189e4,
  ...
  },
  {
    ...
    description: "Track-bred SUV silhouette, race-honed dynamics. The Urus Performante channels Lamborghini's motorsport DNA into the most aggressive Super-SUV ever produced — lighter, louder, and unapologetically Italian.",
    brand: "Lamborghini",
    status: "New",
    category: "Normal",
    priceAED: 142e4,
  ...
  },
  {
    ...
    description: "The pinnacle of front-engined Ferrari engineering. A naturally aspirated V12 in its purest, most savage expression — 789 horsepower of unfiltered Maranello.",
    brand: "Ferrari",
    status: "Used",
    category: "Normal",
    priceAED: 175e4,
  ...
  },
  {
    ...
    description: "British grand touring perfected. The Continental GT Speed is a sculpted alliance of artisan luxury and effortless 650-horsepower W12 power.",
    brand: "Bentley",
    status: "New",
    category: "Normal",
    priceAED: 118e4,
  ...
  },
  {
    ...
    description: "Military-grade ballistic protection wrapped in AMG's most iconic silhouette. Certified B6 — discreet, indestructible, and effortlessly luxurious.",
    brand: "Mercedes-Benz",
    status: "New",
    category: "Armoured",
    priceAED: 21e5,
  ...
  },
  {
    ...
    description: "Hand-built by Land Rover Special Vehicle Operations. VR8-certified armouring engineered to be invisible — preserving the Range Rover's signature elegance.",
    brand: "Range Rover",
    status: "New",
    category: "Armoured",
    priceAED: 245e4,
  ...
  },
  {
    ...
    description: "American executive presence with B6 certified ballistic protection. The Escalade ESV redefines the executive transport with discreet armouring and signature comfort.",
    brand: "Cadillac",
    status: "New",
    category: "Armoured",
    priceAED: 165e4,
  ...
  },
  {
    ...
    description: "Legendary Land Cruiser dependability fortified with B6 ballistic armouring. The first choice of diplomats, executives, and adventurers operating where reliability is non-negotiable.",
    brand: "Toyota",
    status: "Used",
    category: "Armoured",
    priceAED: 98e4,
...
const getCarBySlug = (slug) => cars.find((c) => c.slug === slug);
const brands = Array.from(new Set(cars.map((c) => c.brand))).sort();
const $$splitNotFoundComponentImporter$1 = () => import("./cars._slug-mAqRsamW.js");
const $$splitComponentImporter$1 = () => import("./cars._slug-DklXS0dn.js");
const Route$1 = createFileRoute("/cars/$slug")({
  head: ({
    params
  }) => {
    ...
    return {
      meta: [{
        ...
        name: "description",
        content: car?.description ?? "Vehicle details"
      }, {
        property: "og:title",
        content: car?.title ?? "Vehicle"
      }, {
        property: "og:description",
...
const blog1 = "/assets/blog-1-D6VyNGpv.jpg";
const blog2 = "/assets/blog-2-CKkFBXX0.jpg";
const blog3 = "/assets/blog-3-CsnWhGkz.jpg";
const blogPosts = [
  {
...
const $$splitComponentImporter = () => import("./blogs._slug-C6IWcfW4.js");
const $$splitNotFoundComponentImporter = () => import("./blogs._slug-zrdZQ8HZ.js");
const $$splitErrorComponentImporter = () => import("./blogs._slug-BM3LaZEg.js");
const Route2 = createFileRoute("/blogs/$slug")({
  loader: ({
    params
  }) => {
...
const CarsIndexRoute = Route$3.update({
  id: "/cars/",
  path: "/cars/",
  getParentRoute: () => Route$8
});
const BlogsIndexRoute = Route$2.update({
  id: "/blogs/",
  path: "/blogs/",
  getParentRoute: () => Route$8
});
const CarsSlugRoute = Route$1.update({
  id: "/cars/$slug",
  path: "/cars/$slug",
  getParentRoute: () => Route$8
});
const BlogsSlugRoute = Route2.update({
  id: "/blogs/$slug",
  path: "/blogs/$slug",
  getParentRoute: () => Route$8
});
